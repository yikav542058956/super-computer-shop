...
import { Plus, Edit, Trash, Upload, ImageIcon, Loader2, X, Search, Star, Sparkles, Camera, ScanLine, CheckCircle, AlertCircle, Cpu } from "lucide-react";
          ...
          <div className="space-y-6 py-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="sm:col-span-2 space-y-1">
                ...
                <p className="text-[10px] text-slate-400">💡 Poora model name dalte hi AI specs + MRP auto-fill karega</p>
              </div>
