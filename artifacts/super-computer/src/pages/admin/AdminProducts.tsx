...
import { Plus, Edit, Trash, Upload, ImageIcon, Loader2, X, Search, Star, Sparkles, Camera, ScanLine, CheckCircle, AlertCircle, Cpu, ChevronDown } from "lucide-react";
...
export default function AdminProducts() {
  ...
  const openEdit = (product: any) => {
    ...
    setSeedReviews([]);
    setTotalReviewCount(product.reviewsCount || 0);
    setShowSeedSection(false);
    setShowDialog(true);
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Save review stats + seeded reviews
