  ...
  const applyCoupon = async () => {
    ...
    try {
      ...
      if (couponData.minOrderValue && cartTotal < couponData.minOrderValue) {
        toast.error(`Minimum order value for this coupon is ₹${couponData.minOrderValue.toLocaleString()}`);
        setValidating(false);
        return;
      }
                ...
                <div className="flex items-center justify-between bg-green-50 border border-green-200 rounded-lg px-4 py-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-green-600">Saving ₹{discountAmount.toLocaleString()}</p>
                    </div>
                  </div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between text-slate-600">
                  ...
                  {DELIVERY_CHARGE === 0 ? (
                    ...
                    <span>₹{DELIVERY_CHARGE.toLocaleString()}</span>
                  )}
                </div>
                {DELIVERY_CHARGE === 0 && (
