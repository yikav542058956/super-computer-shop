        ...
        return (
          <div key={label} className="flex items-center">
            <div className="flex flex-col items-center gap-1">
              ...
              <p className={`text-[10px] font-semibold ${active ? "text-green-400" : done ? "text-gray-900" : "text-slate-600"}`}>{label}</p>
            </div>
            {idx < STEPS.length - 1 && (
              <div className={`w-16 sm:w-24 h-0.5 mb-5 mx-1 ${step > num ? "bg-green-500" : "bg-gray-200"}`} />
            )}
          </div>
        );
      })}
...
function GlassCard({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <div className={`bg-white backdrop-blur-sm border border-gray-100 rounded-2xl ${className}`}>
      {children}
    </div>
  );
}
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
          <div className="max-w-sm w-full text-center">
            ...
            <p className="text-xs text-slate-500 mb-6">
              Order ID: <span className="font-mono text-slate-600">{orderId}</span>
            </p>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-4 mb-6 text-left">
              <div className="flex items-center gap-3 mb-3 pb-3 border-b border-gray-100">
                ...
                <div>
                  <p className="text-gray-900 font-semibold text-sm">Cash on Delivery</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-gray-900 font-semibold text-sm">Estimated Delivery</p>
            ...
            <div className="flex flex-col gap-3">
              ...
              <Button
                ...
                className="w-full border-gray-200 text-slate-600 hover:bg-gray-50 rounded-xl h-11"
              >
                Continue Shopping
              </Button>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    <Button
                      variant="outline"
                      onClick={() => setStep(1)}
                      className="border-gray-200 text-slate-600 hover:bg-gray-50 rounded-xl h-11"
                    >
                      Back
                    </Button>
                    <Button
